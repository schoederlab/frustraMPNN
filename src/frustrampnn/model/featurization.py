...
def tied_featurize(
    ...
    for i, b in enumerate(batch):
        ...
        for _step, letter in enumerate(all_chains):
        ...
        if tied_positions_dict is not None:
            ...
            if tied_pos_list:
                set(itertools.chain(*[list(item) for item in tied_pos_list]))
