"""
Batch featurization utilities for ProteinMPNN.

This module contains functions for converting PDB data into batched
tensors suitable for the ProteinMPNN model.
...
def tied_featurize(batch, device, chain_dict, fixed_position_dict=None, omit_AA_dict=None,
                   tied_positions_dict=None, pssm_dict=None, bias_by_res_dict=None, ca_only=False):
    """Pack and pad batch into torch tensors.

    Args:
        batch: List of PDB dictionaries
        device: Torch device
        chain_dict: Dictionary mapping PDB names to (masked_chains, visible_chains)
        fixed_position_dict: Optional dictionary of fixed positions
        omit_AA_dict: Optional dictionary of amino acids to omit
        tied_positions_dict: Optional dictionary of tied positions
        pssm_dict: Optional PSSM dictionary
        bias_by_res_dict: Optional residue bias dictionary
        ca_only: If True, use CA-only coordinates
    ...
    return (X_out, S, mask, lengths, chain_M, chain_encoding_all, letter_list_list,
            visible_list_list, masked_list_list, masked_chain_length_list_list, chain_M_pos,
            omit_AA_mask, residue_idx, dihedral_mask, tied_pos_list_of_lists_list,
