"""
Neural network layers for ProteinMPNN.

This module contains the encoder and decoder layers used in the
ProteinMPNN message-passing neural network architecture.
...
def cat_neighbors_nodes(h_nodes, h_neighbors, E_idx):
    ...
    Args:
        h_nodes: Node features [B, N, C]
        h_neighbors: Neighbor features [B, N, K, C]
