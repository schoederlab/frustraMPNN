"""
Protein feature extraction for ProteinMPNN.

This module contains classes for extracting structural features from
protein coordinates, including radial basis functions and positional encodings.
...
from frustrampnn.model.layers import PositionalEncodings, gather_edges, gather_nodes
...
class CA_ProteinFeatures(nn.Module):
    ...
    def _get_rbf(self, A, B, E_idx):
        """Get RBF features between two sets of coordinates."""
